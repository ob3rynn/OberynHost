...
- the launch catalog still exposes one active `2GB Paper Minecraft Server` product,
...
1. Create a real low-risk checkout with the live `2GB Paper Minecraft Server` price.
